...
# from c2nl.decoders.transformer_parallel import ParallelTransformerDecoder
from c2nl.decoders.transformer_flat import FlatTransformerDecoder
...
class Decoder(nn.Module):
    def __init__(self, args, input_size):
        ...
        if self.split_decoder:
            ...
            self.transformer_c = FlatTransformerDecoder(
            ...
            self.transformer_d = FlatTransformerDecoder(
                num_layers=args.nlayers,
                d_model=self.input_size,
                heads=args.num_head,
                d_k=args.d_k,
            ...
            self.transformer = FlatTransformerDecoder(
                # num_layers=args.nlayers,
                num_layers=args.dec_layers,
                d_model=self.input_size,
                # heads=args.num_head,
