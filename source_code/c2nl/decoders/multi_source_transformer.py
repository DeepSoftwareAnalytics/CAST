...
class SerialTransformerDecoder(DecoderBase):
    ...
    def __init__(self,
                 ...
                 max_relative_positions=0,
                 coverage_attn=False):
        super(SerialTransformerDecoder, self).__init__()
