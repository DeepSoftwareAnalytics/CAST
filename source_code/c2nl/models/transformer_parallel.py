...
class Decoder(nn.Module):
    def __init__(self, args, input_size):
        ...
        if self.split_decoder:
            ...
            self.transformer_c = ParallelTransformerDecoder(
            ...
            self.transformer_d = ParallelTransformerDecoder(
                num_layers=args.nlayers,
                d_model=self.input_size,
                heads=args.num_head,
                d_k=args.d_k,
            ...
            self.transformer = ParallelTransformerDecoder(
                # num_layers=args.nlayers,
                num_layers=args.dec_layers,
                d_model=self.input_size,
                # heads=args.num_head,
...
class Transformer_Parallel(nn.Module):
    ...
    def __init__(self, args, tgt_dict):
        ...
        super(Transformer_Parallel, self).__init__()
